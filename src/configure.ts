...
function serializeTomlValue(value: string | number | string[]): string {
...
function patchTomlValue(source: string, table: string, key: string, value: string | number | string[]): string {
...
function removeTomlValue(source: string, table: string, key: string): string {
  const location = findTable(source, table);
