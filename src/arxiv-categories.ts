/**
 * Full arXiv category taxonomy, generated from https://arxiv.org/category_taxonomy
 * (fetched 2026-07-24). Regenerate by re-parsing that page's
 * <h4>code <span>(Name)</span></h4> entries if arXiv adds or renames categories.
 */
...
export const ARXIV_CATEGORY_CODES: ReadonlySet<string> = new Set(ARXIV_CATEGORIES.map((c) => c.code));
